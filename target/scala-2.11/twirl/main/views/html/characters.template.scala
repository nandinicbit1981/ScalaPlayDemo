                        ...
                        <table class="table-responsive table">
                            ...
                            """),_display_(/*53.30*/characters/*53.40*/.map/*53.44*/ { c =>_display_(Seq[Any](format.raw/*53.51*/("""
                                """),format.raw/*54.33*/("""<tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-primary" data-id=""""),_display_(/*64.90*/c/*64.91*/.id),format.raw/*64.94*/("""" id="deleteCharacter">
                                            delete
                                        </button>
                                    </td>
                                </tr>
